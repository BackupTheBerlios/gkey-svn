...
#define PACKAGE_DOC_DIR "/usr/local/doc/gkey"
...
#define PACKAGE_SOURCE_DIR "/home/nohar/code/gnome/gkey"
...
/* Define to 1 if timestamps are needed to wnck functions */
#define NEED_TIMESTAMPS 1
